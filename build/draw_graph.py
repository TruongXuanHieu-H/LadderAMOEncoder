...
# File name
filename1 = 'reduced_report.txt'
filename2 = 'seq_report.txt'
filename3 = 'BDD_report.txt'
filename4 = 'card_report.txt'
filename5 = 'product_report.txt'
filename6 = 'duplex_report.txt'
filename7 = 'ladder_report.txt'
